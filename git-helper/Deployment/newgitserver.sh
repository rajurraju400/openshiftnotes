...
clustername="testpanclyphub01"
gitns="testpaclypancdgit01"
gitdb="testpaclypancddb01"
gitcbur="testpaclypancdcbur01"
quayurl="quay-registry.apps.panclyphub01.mnc020.mcc714"
quayname="ncd01pan"
quaypasswd="ncd01pan"
domain="apps.panclyphub01.mnc020.mcc714"
...
install_helm_charts() {
    ...
    helm install ncd-git -n "${gitns}" "${gitchartdir}/ncd-git-server-24.9.1-7.g30f1acf.tgz" -f gitupdated.yaml --debug --timeout 20m
}
